...
function navReady() {
    ...
    var addNavReady = function () {
        nav.classList.add('nav-ready');
        afterFirstInteraction(); // clean up event listeners
    };
    var afterFirstInteraction = function () {
